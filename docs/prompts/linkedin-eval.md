# LinkedIn Article Evaluation Prompt

This prompt evaluates a blog post as per the guidelines in `experiments/linkedin-tips.md` and provides suggestions for improvement.
